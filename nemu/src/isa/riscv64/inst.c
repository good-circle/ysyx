...
#define INSTPAT_MATCH(s, name, type, ... /* body */ ) { \
  ...
  INSTPAT("0000000 ????? ????? 101 ????? 00110 11", srliw  , I, R(dest) = (sword_t)((uint32_t)src1 >> ((src2 << 59) >> 59)));
  ...
  INSTPAT("0000000 ????? ????? 101 ????? 01110 11", srlw   , R, R(dest) = (sword_t)((uint32_t)src1 >> ((src2 << 59) >> 59)));
  INSTPAT("0100000 ????? ????? 101 ????? 01110 11", sraw   , R, R(dest) = (sword_t)((int32_t)src1 >> ((src2 << 59) >> 59)));

  // RV32M
  INSTPAT("0000001 ????? ????? 000 ????? 01100 11", mul    , R, R(dest) = src1 * src2);
  //INSTPAT("0000001 ????? ????? 001 ????? 01100 11", mulh   , R, R(dest) = ((sword_t)src1 * (sword_t)src2) >> 64);
  //INSTPAT("0000001 ????? ????? 010 ????? 01100 11", mulhsu , R, R(dest) = (sword_t)((int32_t)(src1 * src2)));
  //INSTPAT("0000001 ????? ????? 011 ????? 01100 11", mulhu  , R, R(dest) = (sword_t)((int32_t)(src1 * src2)));
  //INSTPAT("0000001 ????? ????? 100 ????? 01100 11", div    , R, R(dest) = (sword_t)((int32_t)(src1 * src2)));
  //INSTPAT("0000001 ????? ????? 101 ????? 01100 11", divu   , R, R(dest) = (sword_t)((int32_t)(src1 * src2)));
  //INSTPAT("0000001 ????? ????? 110 ????? 01100 11", rem    , R, R(dest) = (sword_t)((int32_t)(src1 * src2)));
  //INSTPAT("0000001 ????? ????? 111 ????? 01100 11", remu   , R, R(dest) = (sword_t)((int32_t)(src1 * src2)));
