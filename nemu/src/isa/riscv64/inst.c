...
#define INSTPAT_MATCH(s, name, type, ... /* body */ ) { \
  ...
  INSTPAT("??????? ????? ????? 101 ????? 00000 11", lhu    , I, R(dest) = (word_t)((uint16_t)Mr(src1 + src2, 2)));
  ...
  INSTPAT("0000000 ????? ????? 001 ????? 01100 11", sll    , R, R(dest) = (word_t)(src1 << ((src2 << 58) >> 58)));
  ...
  INSTPAT("0000000 ????? ????? 101 ????? 01100 11", srl    , R, R(dest) = (word_t)(src1 >> ((src2 << 58) >> 58)));
  INSTPAT("0100000 ????? ????? 101 ????? 01100 11", sra    , R, R(dest) = (word_t)((sword_t)(src1) >> ((src2 << 58) >> 58)));
  INSTPAT("0000000 ????? ????? 110 ????? 01100 11", or     , R, R(dest) = src1 | src2);
  INSTPAT("0000000 ????? ????? 111 ????? 01100 11", and    , R, R(dest) = src1 & src2);
  
  // RV64I
  INSTPAT("??????? ????? ????? 110 ????? 00000 11", lwu    , I, R(dest) = (word_t)((uint32_t)Mr(src1 + src2, 4)));
  ...
  INSTPAT("0000000 ????? ????? 101 ????? 00110 11", srliw  , I, R(dest) = (sword_t)((int32_t)(src1 >> ((src2 << 59) >> 59))));
  ...
  INSTPAT("0000000 ????? ????? 001 ????? 01110 11", sllw   , R, R(dest) = (word_t)((int32_t)(src1) << ((src2 << 59) >> 59)));
