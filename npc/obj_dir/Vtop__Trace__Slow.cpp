...
void Vtop___024root__traceInitSub0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->declBus(c+3,"top pc", false,-1, 31,0);
        tracep->declBit(c+4,"top a", false,-1);
...
void Vtop___024root__traceFullSub0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->fullIData(oldp+2,(vlSelf->inst),32);
        tracep->fullIData(oldp+3,(vlSelf->pc),32);
        tracep->fullBit(oldp+4,(vlSelf->a));
        tracep->fullBit(oldp+5,((IData)((0x13U == (0x707fU 
                                                   & vlSelf->inst)))));
    }
}
